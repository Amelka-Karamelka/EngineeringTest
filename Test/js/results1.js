...
function displayResult(correct, total) {
    if (correct === total) {
        ...
        localStorage.setItem('stage1Completed', 'true'); // Устанавливаем флаг, что этап 1 пройден
    } else {
...
function addEventListeners() {
    retryBtn.addEventListener('click', () => {
        window.location.href = 'questions1.html'; // Возврат к вопросам этапа 1
    });

    nextBtn.addEventListener('click', () => {
        window.location.href = 'index.html'; // Переход на следующий этап
    });
}
